rootProject.allprojects {
    repositories {
        mavenCentral()
        maven {
            url = uri("https://nttd-tig-324037315774.d.codeartifact.ap-northeast-1.amazonaws.com/maven/com-space-codeartifact/")
            credentials {
                username = "aws"
...
fun executeCodeArtifactGetAuthorizationToken(): String {
    ...
    // $ aws --profile axispot codeartifact get-authorization-token --domain nttd-tig --domain-owner 324037315774 --region ap-northeast-1 --query authorizationToken --output text
    try {
