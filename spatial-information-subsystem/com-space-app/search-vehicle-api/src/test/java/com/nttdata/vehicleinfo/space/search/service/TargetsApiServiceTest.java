...
public class TargetsApiServiceTest {
  ...
  @Autowired private TargetsApiService targetsApiService;
  ...
  public void searchData() {
    ...
    List<MovingObjectStoreData> data =
        targetsApiService.searchObjects(from, to, SpatialId.parse(spatialId));
