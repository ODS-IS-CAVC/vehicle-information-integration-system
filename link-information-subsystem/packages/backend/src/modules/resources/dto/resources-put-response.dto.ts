import { IsArray, IsDateString, IsIn, IsNotEmpty, IsString, ValidateNested } from "class-validator";
...
export class PutResponseStatusDTO {
  @ApiProperty({
    description:
...
export class PutResponseAttributeDTO {
  @ApiProperty({
    enum: Category,
  ...
  @ApiProperty({
    ...
    type: [PutResponseStatusDTO],
  })
  @IsNotEmpty()
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => PutResponseStatusDTO)
  statuses: PutResponseStatusDTO[];
}

export class SharedResourcesPutResponseDTO {
  @ApiProperty({
    enum: DATAMODEL_TYPE,
  ...
  @ValidateNested({ each: true })
  @IsNotEmpty()
  @Type(() => PutResponseAttributeDTO)
  attribute: PutResponseAttributeDTO;
}
